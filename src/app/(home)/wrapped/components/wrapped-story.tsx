  ...
  const slides = [
    {
      ...
      content: (
        <div className='flex flex-col items-center justify-center h-full text-center p-6 text-white space-y-6'>
          ...
          >
            <BookOpen className='w-24 h-24 text-primary mb-4' />
          </motion.div>
          <motion.h1
        ...
        <div className='flex flex-col items-center justify-center h-full text-center p-6 text-white max-w-3xl'>
          ...
          >
            ...
            <p className='text-blue-300'>
              {recap.longestBook?.page_count} pages
            </p>
          </motion.div>
        </div>
      ),
        ...
        <div className='flex flex-col items-center justify-center h-full text-center p-6 text-white space-y-6'>
          ...
          >
            <div className='flex justify-center items-center mb-6'>
              <span
                className='font-extrabold text-3xl text-primary whitespace-nowrap'
                style={{
              ...
              <div className='flex flex-col items-start'>
                <span className='text-sm text-secondary-foreground'>
                  Longest book: {recap.longestBook?.page_count} pages
                </span>
                <Image
                  alt={`${recap.longestBook?.title} cover`}
                  height={230}
                  width={150}
                  src={
                    recap.longestBook?.thumbnail_url ||
            ...
            <div className='my-4'>
              <span className='text-sm text-secondary-foreground flex'>
                Most read genres
              </span>
              <ul className='text-left'>
                {recap.topGenres.map((genre, index) => (
                  <li key={index} className='text-accent-foreground'>
                    {index + 1}. {genre.tag}
                  </li>
                ))}
              </ul>
            ...
            <div className='flex  justify-between w-fullspace-y-4 text-left'>
              {recap.topGenres.length > 0 && (
