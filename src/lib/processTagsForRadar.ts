...
/**
 * Procesa los tags de los libros para crear datos del radar chart
 * Normaliza y cuenta los tags principales
 */
export default function processTagsForRadar(books: Book[]): TagRadarData[] {
